<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="ecommerce_kart.WebForm1" %>
          ...
          <asp:DataList ID="DataList1" runat="server" CellPadding="10" RepeatColumns="3" width="100%" OnItemCommand="DataList1_ItemCommand">
            <ItemTemplate>
               <div class="row">
                  ...
                  <div>
                        <asp:Image ID="Image1" runat="server" Width="327px" Height="200px" class="img-fluid" alt="Image" CommandName="link" ImageUrl='<%# Eval("Img") %>'  />
                  </div>
                <h2 class="item-title">
                   <div>
